...
namespace OKPluginGenericJSONIngest.Transform.JMESPath
{
    public class TransformerJMESPath
    {
        ...
        public static TransformerJMESPath Build(TransformConfigJMESPath config)
        {
            ...
            jmes.FunctionRepository.Register("idMethodByAttributeExists", new IDMethodByAttributeExistsFunc());
        ...
        {
            var r = JsonSerializer.Deserialize<GenericInboundData>(resultJson, GenericInboundDataJsonContext.Default.GenericInboundData);
            if (r == null)
