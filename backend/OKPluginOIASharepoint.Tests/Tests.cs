    ...
    public class Tests
    {
        ...
        public async Task TestLayerAccessProxy()
        {
            var config = new Config(ExternalSharepointTenantID, "mhxconsulting.sharepoint.com", "play2", ExternalSharepointClientID, 
                "/w5tskeWck6EV2sx6Mue1tkL+dSw42VdMHlPS5plohw=", new TimeSpan(100), "sharepoint_test", 
            ...
            var a = await lap.GetAttribute("title_attribute", fakeCIID1, new SharepointExternalListItemID(ExternalSharepointListID, new Guid("5c52717c-bcee-4c30-9070-45d85a37dce8")), TimeThreshold.BuildLatest());
            ...
            Assert.AreEqual(AttributeScalarValueText.Build("3"), a.Value);
            ...
            var aa = await lap.GetAttributes(new List<(Guid, SharepointExternalListItemID)>()
                ...
                }, TimeThreshold.BuildLatest()).ToListAsync();
