...
namespace OnlineInboundAdapterOmnikeeper
{
    ...
    public partial interface ILandscapeRegistryRESTAPIClient
    {
        ...
        /// <summary>list of all CI-types</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CITypeDTO>> GetAllCITypesAsync(string version);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>list of all CI-types</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CITypeDTO>> GetAllCITypesAsync(string version, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class LandscapeRegistryRESTAPIClient : ILandscapeRegistryRESTAPIClient
    {
        ...
        public async System.Threading.Tasks.Task IngestAnsibleInventoryScanAsync(long writeLayerID, System.Collections.Generic.IEnumerable<long> searchLayerIDs, string version, AnsibleInventoryScanDTO body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            foreach (var item_ in searchLayerIDs) { urlBuilder_.Append(System.Uri.EscapeDataString("searchLayerIDs") + "=").Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(System.Collections.Generic.ICollection<CIAttributeDTO>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CITypeDTO>> GetAllCITypesAsync(string version)
        {
            return GetAllCITypesAsync(version, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CITypeDTO>> GetAllCITypesAsync(string version, System.Threading.CancellationToken cancellationToken)
        {
            if (version == null)
                throw new System.ArgumentNullException("version");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/v{version}/CI/getAllCITypes");
            urlBuilder_.Replace("{version}", System.Uri.EscapeDataString(ConvertToString(version, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<CITypeDTO>>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        ...
                        return default(System.Collections.Generic.ICollection<CITypeDTO>);
                    }
                    finally
                    {
                        if (response_ != null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(System.Collections.Generic.ICollection<CIDTO>);
                    }
                    finally
                    {
                        if (response_ != null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(System.Collections.Generic.ICollection<LayerDTO>);
                    }
                    finally
                    {
                        if (response_ != null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(System.Collections.Generic.ICollection<EffectiveTraitSetDTO>);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.21.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class CITypeDTO 
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    ...
    public partial class CIDTO 
    {
        ...
        [Newtonsoft.Json.JsonProperty("type", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public CITypeDTO Type { get; set; } = new CITypeDTO();
