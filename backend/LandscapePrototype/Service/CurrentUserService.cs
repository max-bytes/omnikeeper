...
namespace LandscapePrototype.Service
{
    public class CurrentUserService
    {
        ...
        private async Task<User> CreateUserFromClaims(IEnumerable<Claim> claims, NpgsqlTransaction trans)
        {
            ...
            if (username == null)
            {
                var anonymousGuid = new Guid("2544f9a7-cc17-4cba-8052-e88656cf1ef2"); // TODO: load from claims
                var userInDatabase = UserInDatabase.Build(-1L, anonymousGuid, "anonymous", Entity.UserType.Unknown, DateTimeOffset.Now);
