...
namespace Tests.Ingest
{
    ...
    class LoadAnsibleInventoryTest
    {
        ...
        public async Task Test()
        {
            ...
            var user = new AuthenticatedUser(await userModel.UpsertUser(username, displayName, userGUID, UserType.Robot, mc), new string[] { PermissionUtils.GetLayerWritePermission(layer1) });
