...
namespace Tests.Integration.Serialization
{
    class BaseConfigurationSerializationTest
    {
        ...
        public void TestSerialization()
        {
            ...
            var a = new BaseConfigurationV1(new TimeSpan(97202), "clbRunnerInterval", "markedForDeletionRunnerInterval", "externalIDManagerRunnerInterval", "archiveOldDataRunnerInterval");
