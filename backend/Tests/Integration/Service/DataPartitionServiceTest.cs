...
namespace Tests.Integration.Service
{
    class DataPartitionServiceTest : DIServicedTestBase
    {
        ...
        public async Task TestBasic()
        {
            ...
            var attributesBefore = await attributeModel.GetMergedAttributes(new AllCIIDsSelection(), new Omnikeeper.Base.Entity.LayerSet("1", "2"), ModelContextBuilder.BuildImmediate(), TimeThreshold.BuildLatest(), AllAttributeSelection.Instance);
            ...
            var attributesAfter = await attributeModel.GetMergedAttributes(new AllCIIDsSelection(), new Omnikeeper.Base.Entity.LayerSet("1", "2"), ModelContextBuilder.BuildImmediate(), TimeThreshold.BuildLatest(), AllAttributeSelection.Instance);
