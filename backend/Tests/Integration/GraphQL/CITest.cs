...
namespace Tests.Integration.GraphQL
{
    class CITest : QueryTestBase
    {
        ...
        public async Task TestBasicQuery()
        {
            ...
            await GetService<IAttributeModel>().InsertAttribute("a1", new AttributeScalarValueInteger(3), ciid1, layer1.ID, changeset, new DataOriginV1(DataOriginType.Manual), trans);
            trans.Commit();
