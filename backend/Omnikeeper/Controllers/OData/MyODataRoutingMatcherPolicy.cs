...
namespace Omnikeeper.Controllers.OData
{
    internal class MyODataRoutingMatcherPolicy : MatcherPolicy, IEndpointSelectorPolicy
    {
        ...
        public MyODataRoutingMatcherPolicy(IODataTemplateTranslator translator, EdmModelHolder edmModelHolder)
        {
        ...
        public Task ApplyAsync(HttpContext httpContext, CandidateSet candidates)
        {
            ...
            {
                CandidateState candidate = candidates[i]; // TODO: ref?
                ...
                IEdmModel model = edmModelHolder.GetModel();
