...
namespace Omnikeeper.Base.GraphQL
{
    public interface IDataLoaderService
    {
        ...
        IDataLoaderResult<IDictionary<Guid, EffectiveTrait>> SetupAndLoadEffectiveTraits(ICIIDSelection ciids, ITrait trait, ICIModel ciModel, IAttributeModel attributeModel, IEffectiveTraitModel effectiveTraitModel, ITraitsProvider traitsProvider, LayerSet layerSet, TimeThreshold timeThreshold, IModelContext trans);
