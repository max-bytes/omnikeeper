...
namespace Omnikeeper.Base.Model
{
    public interface ILayerModel
    {
        ...
        Task<Layer> UpsertLayer(string id, string description, Color color, AnchorState state, string clConfig, OnlineInboundAdapterLink oilp, string[] generators, IModelContext trans);
