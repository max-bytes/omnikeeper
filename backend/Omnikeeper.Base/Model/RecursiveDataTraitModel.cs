...
//    {
//        public static readonly RecursiveTrait Trait = new RecursiveTrait(null, "__meta.config.trait", new TraitOriginV1(TraitOriginType.Core),
...
//            return (new RecursiveTrait(null, traitID, new TraitOriginV1(TraitOriginType.Data), requiredAttributes, optionalAttributes, requiredRelations, optionalRelations, requiredTraits), traitID);
//        }
