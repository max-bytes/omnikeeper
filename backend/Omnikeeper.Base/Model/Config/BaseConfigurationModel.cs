...
namespace Omnikeeper.Base.Model.Config
{
    ...
    {
        public BaseConfigurationModel(IEffectiveTraitModel effectiveTraitModel, ICIModel ciModel, IAttributeModel attributeModel, IBaseRelationModel baseRelationModel)
            : base(RecursiveTraitService.FlattenSingleRecursiveTrait(GenericTraitEntityHelper.Class2RecursiveTrait<BaseConfigurationV2>()), effectiveTraitModel, ciModel, attributeModel, baseRelationModel)
        {
        }
