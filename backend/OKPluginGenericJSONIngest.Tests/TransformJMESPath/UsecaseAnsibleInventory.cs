...
namespace OKPluginGenericJSONIngest.Tests.TransformJMESPath
{
    public class UsecaseAnsibleInventory
    {
        ...
        public void Test1()
        {
            ...
            {
                {
                    "setup_facts_h1jmplx01.mhx.at.json", (File.ReadAllText(Path.Combine(Directory.GetParent(ApplicationEnvironment.ApplicationBasePath).Parent.Parent.Parent.ToString(),
                        "data", "usecase_ansible_inventory", "setup_facts_h1jmplx01.mhx.at.json")))
                },
                {
                    "yum_installed_h1jmplx01.mhx.at.json", (File.ReadAllText(Path.Combine(Directory.GetParent(ApplicationEnvironment.ApplicationBasePath).Parent.Parent.Parent.ToString(),
                        "data", "usecase_ansible_inventory", "yum_installed_h1jmplx01.mhx.at.json")))
                },
                {
                    "yum_repos_h1jmplx01.mhx.at.json", (File.ReadAllText(Path.Combine(Directory.GetParent(ApplicationEnvironment.ApplicationBasePath).Parent.Parent.Parent.ToString(),
                        "data", "usecase_ansible_inventory", "yum_repos_h1jmplx01.mhx.at.json")))
                },
                {
                    "yum_updates_h1jmplx01.mhx.at.json", (File.ReadAllText(Path.Combine(Directory.GetParent(ApplicationEnvironment.ApplicationBasePath).Parent.Parent.Parent.ToString(),
                        "data", "usecase_ansible_inventory", "yum_updates_h1jmplx01.mhx.at.json")))
                },
                {
                    "setup_facts_h1lscapet01.mhx.local.json",(File.ReadAllText(Path.Combine(Directory.GetParent(ApplicationEnvironment.ApplicationBasePath).Parent.Parent.Parent.ToString(),
