...
See the the [source code file](backend/Omnikeeper.Base/Service/RecursiveTraitService.cs) for a technical explanation of how dependent traits are resolved and in what order.  
